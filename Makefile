...
# Register user tool
register-user:
	$(CC) $(CFLAGS) -o $(BUILD_DIR)/register_user \
	$(SRC_DIR)/user/register_user.c \
	$(SRC_DIR)/database/insert.c \
	$(SRC_DIR)/database/create.c \
	$(SRC_DIR)/database/select.c \
	$(SRC_DIR)/common/logger.c \
